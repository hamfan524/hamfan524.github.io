...
[파도](https://hamfan524.github.io/Pado/)를 배포한 뒤, 제일 먼저 진행한 리팩토링에 대해 다루려고 한다. 
우린 최대한 출시 일을 앞당기기 위해 기능 만들기에 급급해서 유지보수를 하기 좋은 코드로 개발을 하지 못하였던걸 인지하고 있었고, 배포가 끝난 뒤 바로 리팩토링을 진행하였다.
